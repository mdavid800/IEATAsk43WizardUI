        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              {/* Logo/Brand */}
              <Logo className="mb-8" size="xl" showText={true} variant="clean" />
              ...
              <div className="pt-4 space-y-3">
                ...
                {/* Bottom row - left-offset button */}
                <div className="flex justify-center mr-12">
                  <Button
                    variant="outline"
                    className="px-8 py-4 text-lg font-semibold rounded-2xl border-2 border-secondary/20 hover:border-secondary hover:text-secondary hover:bg-secondary/5 transition-all duration-300 flex items-center gap-2"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              tracking equipment specifications, mounting arrangements, and temporal changes in setup. However, it can be difficult to understand and use for non-technical users.
              This form wizard is a proof of concept implementation of the WRA Data Model that allows users to easily create and manage their measurement station configurations.The code is open source and available on GitHub so you can take a copy and use it for your own purposes.
            </p>
          </div>
